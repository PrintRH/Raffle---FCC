...
!developmentChains.includes(network.name)
    ...
    : describe("Raffle Unit Tests", function () {
          let raffle, vrfCoordinatorV2Mock, raffleEntranceFee, deployer, interval //global storage
          ...
          describe("constructor", function () {
              it("Initializes the raffle correctly", async function () {
                  // Ideally we make each tests only have one assert per "It", but this contract will be slightly loose
          ...
          describe("enterRaffle", function () {
              ...
              it("records players when they enter", async function () {
                  ...
                  assert.equal(playerFromContract, deployer) // Player from contract should be equal to deployer
              })
              ...
              it("doesn't allow entrance when raffle is calculating", async function () {
                  ...
                  await network.provider.send("evm_mine", []) // Just to mine one extra block
          ...
          describe("checkUpkeep", function () {
              it("returns false if players have not send any ETH", async function () {
                  await network.provider.send("evm_increaseTime", [interval.toNumber() + 1])
